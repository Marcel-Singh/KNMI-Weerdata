...
(function () {
    ...
    function G(a, c) {
        ...
        if (b = {
            ...
            }[a || "solid"])for (var d = 0; d <
        b.length; d++)b[d] *= c; else b = [];
        return b
    }
    ...
    function Ra(a) {
        if (!Aa) {
            var c = !1, b = !1;
            "undefined" === typeof aa.Chart.creditHref ? (a.creditHref = "Hello World!"/*"http://canvasjs.com/"*/, a.creditText =
                "Hallo Wereld!"/*"CanvasJS.com"*/) : (c = a.updateOption("creditText"), b = a.updateOption("creditHref"));
    ...
    function A(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            var d = 0, f = 0, d = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, f = this.options.height ? this.height :
    ...
    var y = {}, u = !!document.createElement("canvas").getContext, aa = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        ga = {
            ...
            var a = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, c = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), b = "Sun Mon Tue Wed Thu Fri Sat".split(" "), d = "January February March April May June July August September October November December".split(" "),
                f = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), g = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, k = /[^-+\dA-Z]/g;
            return function (h, l, m) {
                ...
                m = r ? "getUTC" : "get";
                var s = h[m + "Date"](), z = h[m + "Day"](),
                    v = h[m + "Month"](), t = h[m + "FullYear"](), w = h[m + "Hours"](), u = h[m + "Minutes"](), Y = h[m + "Seconds"](), B = h[m + "Milliseconds"](), x = r ? 0 : h.getTimezoneOffset();
            ...
            c = String(c);
            var k = 1, h = b = "", l = -1, m = [], p = [], n = 0, e = 0, q = 0, r = !1, s = 0, h = c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            c = null;
            for (var z = 0; h && z < h.length; z++)if (c = h[z], "." === c && 0 > l)l = z; else {
            ...
            a = (c[1] + "").split("");
            k && "0" === k[0] && k.shift();
            for (r = h = z = e = l = 0; 0 < m.length;)if (c = m.pop(), "#" === c || "0" === c)if (l++, l === n) {
                var v = k, k = [];
                if ("0" === c)for (c = n - e - (v ? v.length : 0); 0 < c;)v.unshift("0"), c--;
                for (; 0 < v.length;)b = v.pop() + b, r++, 0 === r % h && (z === q && 0 < v.length) && (b = g + b)
            } else 0 < k.length ? (b = k.pop() + b, e++, r++) : "0" === c && (b = "0" + b, e++, r++), 0 === r % h && (z === q && 0 < k.length) && (b = g + b); else"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (z++, h = r, r = 0, 0 < k.length &&
            ...
            return {x: c, y: b}
        }, Na = !0, za = window.devicePixelRatio || 1, sa = 1, Q = Na ? za / sa : 1, Aa = window && window.location && window.location.href &&
            window.location.href.indexOf && (-1 !== window.location.href.indexOf("canvasjs.com") || -1 !== window.location.href.indexOf("fenopix.com") || -1 !== window.location.href.indexOf("fiddle")), Sa = {
    ...
    (function () {
        ...
        delete aa[y.fSDec([178,
            215, 208, 225, 227])][y.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
    ...
    (function () {
        ...
        y.fNg = function (a) {
            if (!Aa)try {
                var c;
                a:{
                    var b = RegExp(y.ckDec(y.str.ckn) + "=.*", "gi"), d = new Date, f = document.cookie.match(b), g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(y.ckDec(y.str.ckn)) ?
                ...
                if (c) {
                    ...
                    var v = y.ckDec(y.str.tem), t = z.measureText(v).width;
    ...
    L.prototype.updateOption = function (a) {
        var c = aa[this._defaultsKey], b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ? this.chart.options.theme : "theme1", d = {}, f = this[a];
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c =
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    if (d < z && !q)null !== n.dataPoints[e].y && (s = d); else {
                        if (!q && (q = !0, 0 < e)) {
                            e -= 2;
                            continue
                        }
                        if (d > v && !r)r = !0; else if (d > v && r)continue;
        ...
        function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = !1, h = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (d < s && !e)null !== f && (r = d); else {
                            ...
                            if (d > z && !q)q = !0; else if (d > z && q)continue;
                ...
                a.axisY.logarithmic ? (c.max = x(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && !h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !k && h && (c.max = x(c.viewPortMax) ? -1 : Math.max(c.viewPortMax,
                    -1), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
                c.viewPortMin = c.min;
                c.viewPortMax = c.max;
                a.dataPointYSums = l
            }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, k, h = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
            ...
            for (p = 0; p < m.dataPoints.length; p++) {
                ...
                if (!(d < z) || n) {
                    ...
                    if (d > v && !e)e = !0; else if (d > v && e)continue;
                    m.dataPoints[p].label && (a.axisX.labels[d] =
                        m.dataPoints[p].label);
                    d < b.viewPortMin && (b.viewPortMin = d);
                    d > b.viewPortMax && (b.viewPortMax = d);
                    if (b.viewPortMin === d && f)for (t = 0; t < f.length; t++)if (null === f[t] && q < d) {
                        b.viewPortMin = q;
                        break
                    }
    ...
    A.prototype.getObjectAtXY =
        function (a, c, b) {
            var d = null;
            if (b = this.getDataPointAtXY(a, c, b || !1))d = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (u)d = Ma(a, c, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
    ...
    A.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                f.time = new Date;
                try {
                    var g = f.y - this._lastTouchData.y, k = f.time - this._lastTouchData.time;
                    if (15 < Math.abs(g) && (this._lastTouchData.scroll || 200 > k)) {
                        this._lastTouchData.scroll = !0;
                        var h = window.parent || window;
                        h && h.scrollBy && h.scrollBy(0,
                            -g)
                    }
                } catch (l) {
                }
    ...
    A.prototype._dispatchRangeEvent = function (a, c) {
        ...
        for (var f = 0; f < d.length; f++)if (x(b[d[f]]) && (b[d[f]] = []), "axisY" === d[f])for (var g = 0; g < this.axisY.length; g++)b[d[f]].push({
    ...
    A.prototype._mouseEventHandler = function (a) {
        ...
        if (this.interactivityEnabled)if (this._ignoreNextEvent)this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), !f) {
            if (!A.capturedEventParam && this._events) {
                for (var g = 0; g < this._events.length; g++)if (this._events[g].hasOwnProperty(b))if (d =
    ...
    A.prototype._plotAreaMouseUp = function (a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            var b =
                c - this.dragStartPoint.y, d = a - this.dragStartPoint.x, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), k = !1;
            this.resetOverlayedCanvas();
            if ("xySwapped" === this.plotInfo.axisPlacement)var h = g, g = f, f = h;
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (f = g = 0; f < this._axes.length; f++)b = this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * g, b.sessionVariables.newViewportMaximum = b.viewportMaximum *
                    ...
                    b.viewportMaximum - g, k = !0); else if ((!f || 2 < Math.abs(d)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {
    ...
    A.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, d = 0, f = b = null, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), k = this;
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled)f = {
                ...
                var d = f ? this.dragStartPoint.x : this.plotArea.x1, h = g ? this.dragStartPoint.y : this.plotArea.y1, l = f ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, m = g ? c - this.dragStartPoint.y : this.plotArea.y2 -
                this.plotArea.y1;
    ...
    A.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== w && "" !== w) {
                var v = K("indexLabelPlacement", m.dataPoint, m.dataSeries), t = K("indexLabelOrientation", m.dataPoint, m.dataSeries), ia = m.direction,
                    Y = m.dataSeries.axisX, B = m.dataSeries.axisY, y = !1, q = new V(c, {
                        x: 0,
                        y: 0,
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= p.indexOf("line") || 0 <= p.indexOf("area"))v = "auto", k = 4; else if (0 <= p.indexOf("stacked"))"auto" === v && (v = "inside"); else if ("bubble" === p || "scatter" === p)v = "inside";
                    n = m.point.x - h / 2;
    ...
    A.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var n = k._colorSet, e = n = k.lineColor = k.options.lineColor ? k.options.lineColor : n[0];
                c.strokeStyle = n;
                var q = !0, r = 0, s, z;
                c.beginPath();
                if (0 < h.length) {
                    for (var v = !1, r = 0; r < h.length; r++)if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v)))if ("number" !== typeof h[r].y)0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0; else {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var h = k.dataPoints,
                    l = "solid";
                if (c.setLineDash) {
                    var m = G(k.nullDataLineDashType, k.lineThickness), l = k.lineDashType, p = G(l, k.lineThickness);
                    c.setLineDash(p)
                }
                var n = k.id;
                this._eventManager.objectMap[n] = {objectType: "dataSeries", dataSeriesIndex: g};
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var v = !1, r = 0; r < h.length; r++)if (s = h[r].getTime ? h[r].x.getTime() :
                            h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v)))if ("number" !== typeof h[r].y)0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0; else {
                        var t = z;
                        s = a.axisX.convertValueToPixel(s);
                        z = a.axisY.convertValueToPixel(h[r].y);
    ...
    A.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var r = 0, s, z, v = [];
                b.beginPath();
                if (0 < l.length)for (z = !1, r = 0; r < l.length; r++)if (s = l[r].getTime ? l[r].x.getTime() : l[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !z)))if ("number" !== typeof l[r].y)0 < r && !z && (h.connectNullData ? b.setLineDash && (0 < v.length && (h.options.nullDataLineDashType || !l[r - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = p, m = h.nullDataLineDashType) : (c(v), v = [])), z = !0; else {
                    s = a.axisX.convertValueToPixel(s);
    ...
    A.prototype.renderColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = 0, g, k, h, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth =
                this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), z = d - a.plotType.plotUnits.length * n /
                            2 + a.index * n << 0, v = z + n << 0, t;
                        if (a.axisY.logarithmic)k[b] = r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]), t = f[b] ? f[b] : m, f[b] = l); else if (l = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
                            var w = f[b] ? f[b] : 0;
                            l -= w;
                            t = m - w;
                            f[b] = w + (t - l)
                        ...
                        this._eventManager.objectMap[b] = {
                            ...
                            dataPointIndex: h, x1: z, y1: l, x2: v, y2: t
                        };
                        b = E(b);
    ...
    A.prototype.renderStackedColumn100 = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = [], g = [], k = [], h = 0, l, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, p = this.dataPointMaxWidth ? this.dataPointMaxWidth :
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length)for (var s = 5 < n && q.bevelEnabled ? !0 : !1, h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin ||
                    ...
                    var z = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, v = z + n << 0, t;
    ...
    A.prototype.renderBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = 0, g, k, h, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), z = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, v = z + n << 0, t;
                        if (a.axisY.logarithmic)k[b] =
                            r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (t = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(k[b])); else if (l = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
                            var w = f[b] ? f[b] : 0;
                            t = m + w;
                            l += w;
                            f[b] = w + (l - t)
                        ...
                        (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: r[h],
                            dataSeries: q,
                            point: {x: 0 <= r[h].y ? l : t, y: d},
                            direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: Math.min(t, l), y1: z, x2: Math.max(t, l), y2: v},
                            color: b
                        })
                    }
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), z;
                        z = 0 !== a.dataPointYSums[b] ? 100 * (r[h].y / a.dataPointYSums[b]) : 0;
                        var v = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, t = v + n << 0;
                        if (a.axisY.logarithmic) {
                            k[b] = z + (k[b] ? k[b] : 0);
                            if (0 >= k[b])continue;
                            z = f[b] ? f[b] : m;
    ...
    A.prototype.renderArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, k = [], h = this.plotArea;
            b.save();
            u && d.save();
            b.beginPath();
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                k = E(k);
                d.fillStyle = k;
                var k = [], n = !0, e = 0, q, r, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v, t = null;
                if (0 < p.length) {
                    var w = m._colorSet[e % m._colorSet.length], x = m.lineColor = m.options.lineColor || w, y = x;
                    b.fillStyle = w;
                    b.strokeStyle = x;
                    b.lineWidth = m.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var A = G(m.nullDataLineDashType, m.lineThickness), B = m.lineDashType, C = G(B, m.lineThickness);
                        b.setLineDash(C)
                    }
                    for (var N = !0; e < p.length; e++)if (s = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !N)))if ("number" !== typeof p[e].y)m.connectNullData || (N || n) || c(), N = !0; else {
    ...
    A.prototype.renderSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                k = E(k);
                d.fillStyle = k;
                var k = [], n = 0, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s, z = null, v = [];
                if (0 < p.length) {
                    var t = m._colorSet[n % m._colorSet.length], w = m.lineColor = m.options.lineColor || t, x = w;
                    b.fillStyle = t;
                    b.strokeStyle = w;
                    b.lineWidth = m.lineThickness;
                    var y = "solid";
                    if (b.setLineDash) {
                        var B = G(m.nullDataLineDashType, m.lineThickness), y = m.lineDashType, A = G(y, m.lineThickness);
                        b.setLineDash(A)
                    }
                    for (q = !1; n < p.length; n++)if (e = p[n].x.getTime ?
                            p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))if ("number" !== typeof p[n].y)0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = B, y = m.nullDataLineDashType) : (c(), v = [])), q = !0; else {
                        e = a.axisX.convertValueToPixel(e);
                        q = a.axisY.convertValueToPixel(p[n].y);
                        var C = m.dataPointIds[n];
                        this._eventManager.objectMap[C] = {
                            id: C, objectType: "dataPoint", dataSeriesIndex: l,
                            dataPointIndex: n, x1: e, y1: q
                        };
                        v[v.length] = {x: e, y: q};
                        ...
                        if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < m.markerSize)) {
                            ...
                            C = E(C);
                            u && k.push({
                                x: e, y: q, ctx: d, type: N.type, size: N.size,
    ...
    A.prototype.renderStepArea =
        function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var d =
                    this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, k = [], h = this.plotArea;
                b.save();
                u && d.save();
                b.beginPath();
                b.rect(h.x1, h.y1, h.width, h.height);
                ...
                for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    k = E(k);
                    d.fillStyle = k;
                    var k = [], n = !0, e = 0, q, r, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        a.axisY.viewportMinimum : 0), v, t = null, w = !1;
                    if (0 < p.length) {
                        var x = m._colorSet[e % m._colorSet.length], y = m.lineColor = m.options.lineColor || x, B = y;
                        b.fillStyle = x;
                        b.strokeStyle = y;
                        b.lineWidth = m.lineThickness;
                        var A = "solid";
                        if (b.setLineDash) {
                            var C = G(m.nullDataLineDashType, m.lineThickness), A = m.lineDashType, N = G(A, m.lineThickness);
                            b.setLineDash(N)
                        }
    ...
    A.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, f = [], g = this.plotArea, k = [], h = [], l = [], m = [], p = 0, n, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx;
            u && s.beginPath();
            b.save();
            u && s.save();
            b.beginPath();
            ...
            for (var z = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                var v = a.dataSeriesIndexes[g], t = this.data[v], w = t.dataPoints;
                t.dataPointIndexes = [];
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                s.fillStyle = p;
                if (0 < l.length) {
                    var d = t._colorSet[0], x = t.lineColor = t.options.lineColor || d, y = x;
                    b.fillStyle = d;
                    b.strokeStyle = x;
                    b.lineWidth = t.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var A = G(t.nullDataLineDashType, t.lineThickness), B = t.lineDashType, C = G(B, t.lineThickness);
                        b.setLineDash(C)
                    }
                    for (var N = !0, p = 0; p < l.length; p++) {
                        q = l[p];
                        var H = null, H = 0 <= t.dataPointIndexes[q] ?
                            w[t.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))if ("number" !== typeof H.y)t.connectNullData || (N || z) || c(), N = !0; else {
    ...
    A.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, f = this.plotArea, g = [], k = [], h = [], l = [], m = [], p = 0, n, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx;
            b.save();
            u && s.save();
            b.beginPath();
            ...
            for (var z = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var v = a.dataSeriesIndexes[f], t = this.data[v], w = t.dataPoints;
                t.dataPointIndexes = [];
                for (p = 0; p < w.length; p++)v = w[p].x.getTime ? w[p].x.getTime() : w[p].x, t.dataPointIndexes[v] = p, z[v] || (l.push(v), z[v] = !0);
                l.sort(ya)
            }
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                h = [];
                if (0 < l.length) {
                    var d = t._colorSet[p % t._colorSet.length], x = t.lineColor = t.options.lineColor || d, y = x;
                    b.fillStyle = d;
                    b.strokeStyle = x;
                    b.lineWidth = t.lineThickness;
                    var B = "solid";
    ...
    A.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = -Infinity, h = Infinity,
                     l = 0; l < a.dataSeriesIndexes.length; l++)for (var m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, e = 0, d = 0; d < n.length; d++)f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[d].z || (e = n[d].z, e > k && (k = e), e < h && (h = e));
            for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), l = 0; l < a.dataSeriesIndexes.length; l++)if (m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, 0 < n.length)for (c.strokeStyle =
                                                                                                                                                                                                                                                            "#4572A7 ", d = 0; d < n.length; d++)if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                f = a.axisX.convertValueToPixel(f);
                g = a.axisY.convertValueToPixel(n[d].y);
                var e = n[d].z, r = 2 * Math.max(Math.sqrt((k === h ? b / 2 : q + (b - q) / (k - h) * (e - h)) / Math.PI) << 0, 1), e = p.getMarkerProperties(d, c);
                e.size = r;
    ...
    A.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                var h = a.dataSeriesIndexes[k], l = this.data[h], m = l.dataPoints;
                if (0 < m.length) {
                    c.strokeStyle = "#4572A7 ";
    ...
    A.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d =
                null, d = this.plotArea, f = 0, g, k, h, l, m, p, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)for (var z = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ?
                    ...
                    var v = g - n / 2 << 0, t = v + n << 0, d = s[f].color ? s[f].color : r._colorSet[0],
                        w = Math.round(Math.max(1, 0.15 * n)), x = 0 === w % 2 ? 0 : 0.5, y = r.dataPointIds[f];
                    ...
                    (s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: s[f],
                        dataSeries: r,
                        point: {x: v + (t - v) / 2, y: a.axisY.reversed ? l : h},
                        direction: 1,
                        bounds: {x1: v, y1: Math.min(h, l), x2: t, y2: Math.max(h, l)},
                        color: d
                    })
                }
            }
        ...
        function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints;
                    if (0 < n.length)for (var e = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
                        ...
                        var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + l) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + l) * h << 0, r = a.axisX.reversed ? q - h << 0 : q + h << 0, b = n[f].color ? n[f].color : p._colorSet[f % p._colorSet.length];
                        if (d > g) {
                            var s = d, d = g;
                            g = s
                        }
    ...
    A.prototype.renderRangeBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            return {
                ...
                animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad, animationBase: 0
            }
        }
    };
    A.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                f = E(f);
                d.fillStyle = f;
                var f = [], p = !0, n = 0, e, q, r, s, z = null;
                if (0 < m.length) {
                    var v = l._colorSet[n % l._colorSet.length], t = l.lineColor = l.options.lineColor || v, w = t;
                    b.fillStyle = v;
                    b.strokeStyle = t;
                    b.lineWidth = l.lineThickness;
                    var x = "solid";
                    if (b.setLineDash) {
                        var y = G(l.nullDataLineDashType, l.lineThickness), x = l.lineDashType, B = G(x, l.lineThickness);
                        b.setLineDash(B)
                    }
                    for (var A = !0; n < m.length; n++)if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !A)))if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
    ...
    A.prototype.renderRangeSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            u && (d.beginPath(), d.rect(g.x1, g.y1, g.width, g.height), d.clip());
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                var k = a.dataSeriesIndexes[g], h = this.data[k], l = h.dataPoints,
                    f = h.id;
                ...
                var f = [], m = 0, p, n, e, q = [], r = [];
                if (0 < l.length) {
                    var s = h._colorSet[m % h._colorSet.length], z = h.lineColor = h.options.lineColor || s, v = z;
                    b.fillStyle = s;
                    b.lineWidth = h.lineThickness;
                    var t = "solid", w;
                    if (b.setLineDash) {
                        var x = G(h.nullDataLineDashType, h.lineThickness), t = h.lineDashType;
                        w = G(t, h.lineThickness)
                    }
                    for (n = !1; m < l.length; m++)if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax &&
                        (!h.connectNullData || !n)))if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] && "number" === typeof l[m].y[1]) {
                        ...
                        if (0 !== l[m].markerSize && (0 < l[m].markerSize || 0 < h.markerSize)) {
                            ...
                            A = E(y);
                            u && f.push({
                                x: p, y: e, ctx: d, type: B.type,
                                size: B.size, color: A, borderColor: A, borderThickness: B.borderThickness
                            })
                        }
    ...
    A.prototype.renderPie = function (a) {
        ...
        function b(a) {
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * B * Math.cos(q[b].midAngle), g = 0.07 * B * Math.sin(q[b].midAngle), h = !1;
                    if (p[b].exploded) {
        ...
        function k() {
            ...
            for (var b = a = 0, c = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                } else for (a = 0; a < p.length; a++)k = q[a], s = "pie" === m.type ? 0.7 * B : 0.8 * B, x = w.x + s * Math.cos(k.midAngle), u = w.y + s * Math.sin(k.midAngle), k.indexLabelTextBlock.x = x, k.indexLabelTextBlock.y = u;
                for (a = 0; a < p.length; a++)if (k = q[a], x = k.indexLabelTextBlock.measureText(),
                    ...
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < p.length; g++)if (e = !1, v = q[g], v.indexLabelText) {
                        ...
                        if (null !== k) {
                            ...
                            if (l = 0 > y) {
                                ...
                                var m = v.indexLabelTextBlock.y - v.indexLabelTextBlock.height / 2, r = v.indexLabelTextBlock.y + v.indexLabelTextBlock.height / 2, s = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, t = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, u = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
    ...
    V.prototype._wrapText = function () {
        ...
        if (0 === this.frontSize)f = d = 0; else for (; 0 < a.length;) {
            var g = this.maxHeight - 2 * this.padding, k = this._getLineWithWidth(a, this.maxWidth - 2 * this.padding, !1);
    ...
    ma.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(),
                b = c.x1, d = c.y1, f = 0, g = 0, k = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, h, l;
    ...
    wa.prototype.render = function () {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = null, d = 0, f = 0, g = 0, k = 0, h = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ?
        ...
        for (var p = 0; p < this.dataSeries.length; p++) {
            ...
            if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
                var e = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? Z.getDefaultLegendMarker(n.type) : n.markerType, q = n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this.options,
                    dataSeries: n,
                    dataPoint: null
                ...
                var w = n.dataPoints[t], e = w.legendMarkerType ? w.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : Z.getDefaultLegendMarker(n.type), q = w.legendText ? w.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this.options,
                    dataSeries: n,
                    dataPoint: w
                ...
                n.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, w, n, t), e = {
                    markerType: e,
                    markerColor: r,
                    text: q,
                    textBlock: null,
    ...
    Z.prototype.getDataPointAtX = function (a, c) {
        ...
        var b = {
            ...
            distance: Infinity,
            index: NaN
        }, d = null, f = 0, g = 0, k = 1, h = Infinity, l = 0, m = 0, p = 0;
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = K("markerSize", q, this) || 4, u = b ? 20 : s, r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
    ...
    C.setLayoutAndRender = function (a, c, b, d, f, g) {
        ...
        var q = 0, r = 0, s = 0, u = 0, v = 0, t = 0, w = 0, y, A, B = h = 0, C, E, F, H;
        C = E = F = H = !1;
        ...
        if ("normal" === f) {
            ...
            if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.height, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ? 0.8 * g.width : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle =
                90);
            for (; 4 > q;) {
                var M = 0, Q = 0, P = 0, O = 0, K = f = 0, D = 0, R = 0, W = 0, U = 0, T = 0, S = 0;
                if (b && 0 < b.length)for (t = [], e = T = 0; e < b.length; e++)t.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), T += t[e], D += b[e] ? b[e].margin : 0; else t.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                L.push(t);
                if (d && 0 < d.length)for (w = [], e = S = 0; e < d.length; e++)w.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), S += w[e], R += d[e] ? d[e].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                J.push(w);
                k = Math.round(g.x1 + T + D);
                l = Math.round(g.x2 - S - R > p.width - 10 ? p.width - 10 : g.x2 - S - R);
                if (a && 0 < a.length)for (u = [], e = W = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(l - k), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width), u.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), W += u[e], f += a[e] ? a[e].margin : 0; else u.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                    0));
                G.push(u);
                if (c && 0 < c.length)for (v = [], e = U = 0; e < c.length; e++)c[e] && (c[e].lineCoordinates = {}), c[e].lineCoordinates.width = Math.abs(l - k), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), v.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)), U += v[e], K += c[e] ? c[e].margin : 0; else v.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                I.push(v);
                ...
                if (b &&
                    ...
                    x1: k - (t[e] +
                    P), y1: h, x2: l, y2: m, width: l - k, height: m - h
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), l = Math.round(k), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(g.y1 + U + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 +
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && (a[e].calculateValueToPixelConversionParameters(), a[e]._labels &&
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].calculateValueToPixelConversionParameters(), c[e]._labels && 1 < c[e]._labels.length && (y = (c[e].logarithmic ? Math.log(c[e]._labels[1].position /
                ...
                if (0 < q) {
                    if (a && 0 < a.length)for (e = 0; e < a.length; e++)C =
                        G[q - 1][e] === G[q][e] ? !0 : !1; else C = !0;
                    ...
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)H = J[q - 1][e] === J[q][e] ? !0 : !1; else H = !0
                }
                if (C && E && F && H)break;
                q++
            }
            ...
            I = [];
            L = [];
            if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 *
            ...
            for (; 4 > q;) {
                ...
                if (a && 0 < a.length)for (B = [], e = W = 0; e < a.length; e++)B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)), W += B[e], f += a[e] ? a[e].margin : 0; else B.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                I.push(B);
                if (c && 0 < c.length)for (r =
                                               [], e = U = 0; e < c.length; e++)r.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), U += r[e], K += c[e] ? c[e].margin : 0; else r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                L.push(r);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, k = Math.round(g.x1 + W + f), l = Math.round(g.x2 - U - K > p.width - 10 ? p.width - 10 : g.x2 - U - K), b[e].labelAutoFit && !x(u) && (0 < !a.length && (k = 0 > b[e].labelAngle ? Math.max(k, u) : 0 === b[e].labelAngle ? Math.max(k, u / 2) : k), 0 < !c.length && (l = 0 < b[e].labelAngle ? l - v / 2 : 0 === b[e].labelAngle ?
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e].lineCoordinates = {}, k = Math.round(g.x1 + W + f), l = Math.round(g.x2 - U - K > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - U - K), d[e] && d[e].labelAutoFit && !x(t) && (0 < !a.length && (k = 0 < d[e].labelAngle ? Math.max(k, t) :
                ...
                if (b && 0 < b.length)for (y = [], e = O = 0; e < b.length; e++)y.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += y[e] + b[e].margin, D += b[e].margin; else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() :
                    0));
                s.push(y);
                ...
                G.push(A);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 < b[e]._labels.length && (m = b[e]._labels[0], h = b[e]._labels[b[e]._labels.length - 1], u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], h = d[e]._labels[d[e]._labels.length - 1], t = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) +
                    (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                if (p.panEnabled)for (e = 0; e < b.length; e++)y[e] = p.sessionVariables.axisY.height; else for (e = 0; e < b.length; e++)p.sessionVariables.axisY.height = y[e];
                if (b && 0 < b.length)for (e = b.length - 1; 0 <= e; e--)h = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = h - (y[e] + b[e].margin + M), b[e].lineCoordinates.y2 = h - (y[e] + b[e].margin + M), b[e].bounds = {
                    x1: k, y1: h - (y[e] + M + b[e].margin),
                    x2: l, y2: m - (M + b[e].margin), width: l - k, height: y[e]
                ...
                if (d && 0 < d.length)for (e = d.length - 1; 0 <= e; e--)d[e] && (h = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + Q)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
                    x1: k,
                    y1: h + (d[e].margin + Q),
                    x2: l,
                    y2: m,
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++) {
                    ...
                    if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, u) : 0 === b[D].labelAngle ? Math.max(l, u / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - W : k);
                    if (d && 0 < d.length)for (D = 0; D < d.length; D++)d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x1, k = l - W);
                    a[e].lineCoordinates = {x1: l - J, y1: h, x2: l - J, y2: m, height: Math.abs(m - h)};
                    a[e].bounds = {
                        x1: l - (B[e] + J), y1: h, x2: l, y2: m, width: l -
                        k, height: m - h
                    };
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++) {
                    ...
                    if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - U : k);
                    if (d && 0 < d.length)for (D = 0; D < d.length; D++)d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x2, k = l - U);
                    c[e].lineCoordinates =
                    {x1: l + P, y1: h, x2: l + P, y2: m, height: Math.abs(m - h)};
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)H = G[q - 1][e] === G[q][e] ? !0 : !1; else H = !0
                }
                if (C && E && F && H)break;
                q++
            }
    ...
    C.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (k)for (k = !1, d = 0; d < l.length; d++)b = l[d], b.stripLine.showOnTop ?
            k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
    ...
    C.prototype.calculateAxisParameters =
        function () {
            if (this.logarithmic)this.calculateLogarithamicAxisParameters(); else {
                ...
                var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40, d = 4;
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (l = this.chart.getDataPointAtXY(a, c, b))this.currentDataPointIndex =
                    l.dataPointIndex, this.currentSeriesIndex = l.dataSeries.index; else if (u)if (l = Ma(a, c, this.chart._eventManager.ghostCtx), 0 < l && "undefined" !== typeof this.chart._eventManager.objectMap[l]) {
    ...
    A.prototype.replaceKeywordsWithValue = function (a, c, b, d, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var k = "#percent", h = "#total", l = this.getPercentAndTotal(b, c), h = isNaN(l.total) ? h : l.total, k = isNaN(l.percent) ? k : l.percent;
            do {
                l = "";
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            } else return ba(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo); else return "y" === a ? ba(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########",
